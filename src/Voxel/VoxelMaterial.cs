...
public static class VoxelMaterials
{
    private static readonly Dictionary<VoxelMaterialType, VoxelMaterialDefinition> Definitions = new Dictionary<VoxelMaterialType, VoxelMaterialDefinition>
    {
        ...
        [VoxelMaterialType.Stone] = new VoxelMaterialDefinition(20, 15, 1.2f, false, false, false, false, 0f),
        [VoxelMaterialType.Brick] = new VoxelMaterialDefinition(25, 20, 1.3f, false, false, false, false, 0f),
        [VoxelMaterialType.Concrete] = new VoxelMaterialDefinition(30, 28, 1.8f, false, false, false, false, 0f),
        [VoxelMaterialType.Metal] = new VoxelMaterialDefinition(35, 40, 2.0f, false, false, false, false, 0.12f),
        [VoxelMaterialType.ReinforcedSteel] = new VoxelMaterialDefinition(45, 55, 2.5f, false, false, false, false, 0.2f),
        [VoxelMaterialType.Glass] = new VoxelMaterialDefinition(12, 2, 0.2f, true, false, false, false, 0f),
        [VoxelMaterialType.Obsidian] = new VoxelMaterialDefinition(50, 60, 2.8f, false, false, false, false, 0.1f),
        ...
        [VoxelMaterialType.ArmorPlate] = new VoxelMaterialDefinition(40, 45, 2.2f, false, false, false, true, 0.15f),
