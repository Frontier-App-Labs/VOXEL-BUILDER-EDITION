...
public static class VoxelMaterials
{
    private static readonly Dictionary<VoxelMaterialType, VoxelMaterialDefinition> Definitions = new Dictionary<VoxelMaterialType, VoxelMaterialDefinition>
    {
        ...
        [VoxelMaterialType.Dirt] = new VoxelMaterialDefinition(10, 3, 0.8f, false, false, false, false, 0f),
        [VoxelMaterialType.Wood] = new VoxelMaterialDefinition(15, 8, 0.5f, false, true, false, false, 0f),
        [VoxelMaterialType.Stone] = new VoxelMaterialDefinition(20, 18, 1.2f, false, false, false, false, 0f),
        [VoxelMaterialType.Brick] = new VoxelMaterialDefinition(25, 24, 1.3f, false, false, false, false, 0f),
        [VoxelMaterialType.Concrete] = new VoxelMaterialDefinition(30, 36, 1.8f, false, false, false, false, 0f),
        [VoxelMaterialType.Metal] = new VoxelMaterialDefinition(35, 56, 2.0f, false, false, false, false, 0.12f),
        [VoxelMaterialType.ReinforcedSteel] = new VoxelMaterialDefinition(45, 84, 2.5f, false, false, false, false, 0.2f),
        [VoxelMaterialType.Glass] = new VoxelMaterialDefinition(12, 2, 0.2f, true, false, false, false, 0f),
        [VoxelMaterialType.Obsidian] = new VoxelMaterialDefinition(50, 105, 2.8f, false, false, false, false, 0.1f),
        [VoxelMaterialType.Sand] = new VoxelMaterialDefinition(10, 4, 0.7f, false, false, true, false, 0f),
        [VoxelMaterialType.Ice] = new VoxelMaterialDefinition(12, 6, 0.6f, true, false, false, false, 0f),
        [VoxelMaterialType.ArmorPlate] = new VoxelMaterialDefinition(40, 70, 2.2f, false, false, false, true, 0.15f),
        [VoxelMaterialType.Foundation] = new VoxelMaterialDefinition(0, 178, 999f, false, false, false, false, 0f),
        [VoxelMaterialType.Leaves] = new VoxelMaterialDefinition(10, 3, 0.2f, false, true, false, false, 0f),
        [VoxelMaterialType.Bark] = new VoxelMaterialDefinition(15, 10, 0.8f, false, true, false, false, 0f),
    };
