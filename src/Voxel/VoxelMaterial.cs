...
public static class VoxelMaterials
{
    private static readonly Dictionary<VoxelMaterialType, VoxelMaterialDefinition> Definitions = new Dictionary<VoxelMaterialType, VoxelMaterialDefinition>
    {
        ...
        [VoxelMaterialType.ReinforcedSteel] = new VoxelMaterialDefinition(65, 26, 2.5f, false, false, false, false, 0.2f),
        [VoxelMaterialType.Glass] = new VoxelMaterialDefinition(12, 1, 0.2f, true, false, false, false, 0f),
        [VoxelMaterialType.Obsidian] = new VoxelMaterialDefinition(80, 30, 2.8f, false, false, false, false, 0.1f),
        ...
        [VoxelMaterialType.ArmorPlate] = new VoxelMaterialDefinition(55, 21, 2.2f, false, false, false, true, 0.15f),
